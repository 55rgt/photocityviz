<template lang="pug">
  .wrapper
    .header.box-shadow
      ...
      .header-sub Identifying the Color and the Theme of City.
    .content
...
.wrapper
  ...
  .header
    ...
    .header-title
      ...
      height: 100%
      margin-right: $unit-2
      @include setFonts('Roboto', $md-dark-text-primary, $unit-5)
    .header-sub
      width: auto
      height: 100%
  ...
  .content
    ...
    .subView-container
      width: calc(100% - #{$mainView-container-width} - #{$mainView-margin-right})
      height: 100%
      background: $md-white
